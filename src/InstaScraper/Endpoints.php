...
class Endpoints
{
    ...
    const ACCOUNT_MEDIAS2 = 'https://www.instagram.com/graphql/query/?query_id=17880160963012870&id={accountId}&first={post_num}&after=';
    // Look alike??
    ...
    public static function getAccountMediasJsonLink($accountId, $post_num = '')
    {
        $url = str_replace('{accountId}', urlencode($accountId), Endpoints::ACCOUNT_MEDIAS2);
        return str_replace('{post_num}', urlencode($post_num), $url);
    }
